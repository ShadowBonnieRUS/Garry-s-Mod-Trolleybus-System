...
ENT.TrolleyPoleCatcherPos = Vector(-241,0,-22)
...
ENT.WheelsData = {
	{
		...
		Turn = true,
		Wheels = {
			{Type = "aksm321n",	Pos = Vector(138.5,45,-50),		Right = false,	Height = 1,		Constant = 50000,	Damping = 1300,	RDamping = 1300,	Times = 8},
			{Type = "aksm321n",	Pos = Vector(138.5,-45,-50),	Right = true,	Height = 0.25,	Constant = 50000,	Damping = 1300,	RDamping = 1300,	Times = 8},
		},
	},
	{
		Drive = true,
		Turn = false,
		Wheels = {
			{Type = "aksm321n_rear",	Pos = Vector(-99.5,38,-50),		Right = false,	Height = 3,		Constant = 50000,	Damping = 1300,	RDamping = 1300,	Times = 8},
			{Type = "aksm321n_rear",	Pos = Vector(-99.5,-38,-50),	Right = true,	Height = 2.25,	Constant = 50000,	Damping = 1300,	RDamping = 1300,	Times = 8},
		},
	},
}
