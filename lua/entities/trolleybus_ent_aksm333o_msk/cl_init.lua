...
ENT.IconOverride = "trolleybus/trolleybus_icons/aksm333o_msk.png"
...
local interior = "models/trolleybus/aksm333o/interior_msk.mdl"
local interior2 = "models/trolleybus/aksm333o/interior2_msk.mdl"
local lamp = "models/trolleybus/aksm333o/lamp.mdl"
local wipers = "models/trolleybus/aksm333o/wipers_msk.mdl"
...
function ENT:CreateClientEnts()
	...
	local interior = CreateModel(self,"interior",interior)
	interior:SetBodygroup(1,self:GetSpawnSetting("cabine_handrail") and 0 or 1)
	
	local interior2 = CreateModel(self,"interior2",interior2)
	interior2:SetBodygroup(2,self:GetSpawnSetting("cabine_handrail") and 0 or 1)
