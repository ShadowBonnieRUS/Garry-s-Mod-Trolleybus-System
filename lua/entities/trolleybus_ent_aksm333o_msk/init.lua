...
function ENT:InitializeLowVoltageCircuit()
	...
	self.ElLowCircuit:BuildFromData({
		...
		{node1name = "doorlight1node",node2name = "doorlight1node2",
			{name = "doorlight1key",State = function() return self:IsPriborButtonActive("doorlights") and (self:DoorIsOpened("door1") or self:DoorIsOpened("door2")) end},
...
ENT.WheelsData = {
	{
		...
		Turn = true,
		Wheels = {
			{Type = "aksm333o",	Pos = Vector(248.5,46,-44),		Right = false,	Height = 6,	Constant = 50000,	Damping = 1300,	RDamping = 1300,	Times = 8},
			{Type = "aksm333o",	Pos = Vector(248.5,-46,-44),	Right = true,	Height = 6,	Constant = 50000,	Damping = 1300,	RDamping = 1300,	Times = 8,		KneelingMul = 0.7},
		},
	},
	{
		Drive = true,
		Turn = false,
		Wheels = {
			{Type = "aksm333o_rear",	Pos = Vector(10,38,-44),	Right = false,	Height = 4,	Constant = 50000,	Damping = 1300,	RDamping = 1300,	Times = 8},
			{Type = "aksm333o_rear",	Pos = Vector(10,-38,-44),	Right = true,	Height = 4,	Constant = 50000,	Damping = 1300,	RDamping = 1300,	Times = 8,	KneelingMul = 0.7},
		},
	},
}
