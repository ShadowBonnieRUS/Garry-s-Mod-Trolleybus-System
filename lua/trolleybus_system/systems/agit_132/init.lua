...
function SYSTEM:StopSound()
	...
	self:SetNWVar("Playing",false)
end

function SYSTEM:OnPlayButtonPressed()
...
function SYSTEM:OnEditButtonPressed()
	if self:IsRouteState() then
