...
TOOL.Name = "#tool.trolleybus_routes_editor.name"

TOOL.Information = {}

function TOOL:Allowed()
	if !Trolleybus_System.RunEvent("HasAccessToTool",self:GetOwner(),"trolleybus_routes_editor") then return false end
